...
`Calendar` forwards all props to [React DayPicker](https://daypicker.dev/api/type-aliases/DayPickerProps/), including `mode`, `selected`, `onSelect`, `numberOfMonths`, `captionLayout`, `showWeekNumber`, `disabled`, and `locale`.
  ...
  data={[
    {
      ...
      default: '"text"',
      description: "The button variant used for the previous and next month buttons.",
    },
    {
      prop: "className",
      type: "string",
