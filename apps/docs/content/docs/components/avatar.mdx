...
Built on the [Radix UI Avatar](https://www.radix-ui.com/primitives/docs/components/avatar) primitive. `Avatar`, `AvatarImage`, and `AvatarFallback` forward all props to their Radix counterparts; `AvatarGroup` is a Hummingbird addition.
