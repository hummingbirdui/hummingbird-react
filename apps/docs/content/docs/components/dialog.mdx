...
- See the full list of available dialog classes in the [Class overview](https://hbui.dev/docs/components/modal/#class-overview).
- Visit the [CSS Variables](https://hbui.dev/docs/components/modal/#css-variables) documentation to explore all available variables.
