...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: "boolean",
      default: "true",
      description: "Shows the styled arrow pointing at the trigger.",
    },
    {
...
- See the full list of available popover classes in the [Class overview](https://hbui.dev/docs/components/popovers/#class-overview).
- Visit the [CSS Variables](https://hbui.dev/docs/components/popovers/#css-variables) documentation to explore all available variables.
