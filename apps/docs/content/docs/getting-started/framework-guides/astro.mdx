...
`DarkThemeToggle` switches between light and dark mode, persists the choice, and keeps browser tabs in sync. It needs a client directive to be interactive. For custom controls, use the [useThemeMode hook](/docs/customize/dark-mode#the-usethememode-hook).
