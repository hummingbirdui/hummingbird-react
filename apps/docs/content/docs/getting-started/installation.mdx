...
Using a framework? The [framework guides](/docs/getting-started/framework-guides) cover Next.js, Vite, Astro, Remix, React Router, and Gatsby step by step, including dark mode setup.
...
For theme-level changes such as colors and spacing, Hummingbird provides global and component-specific CSS variables. See the [Customize section](/docs/customize/component) for details.
