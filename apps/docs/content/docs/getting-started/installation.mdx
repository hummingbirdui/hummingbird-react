...
Using a framework? The [framework guides](/docs/getting-started/framework-guides) cover Next.js, Vite, Astro, React Router, and Gatsby step by step, including dark mode setup.
